...
async function draw_violin() {

    data = await d3.csv("https://raw.githubusercontent.com/holtzy/D3-graph-gallery/master/DATA/iris.csv");
    ...
    // var sumstat = d3.group()  // group function allows to group the calculation per level of a factor
